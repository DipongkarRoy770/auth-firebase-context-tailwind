...
const Footer = () => {
  return (
    <footer className="footer footer-center p-10 h-40 bg-gradient-to-r from-cyan-100 to-blue-100 w-11/12 mx-auto mt-12 ">
  <div>
    ...
    <p className="font-bold">
      DIP Industries Ltd. <br/>Providing reliable tech since 2001
    </p> 
    <p>Copyright © 2023 - All right reserved</p>
  </div> 
  <div>
    <div className="grid grid-flow-col gap-4 -mt-6 mb-6">
